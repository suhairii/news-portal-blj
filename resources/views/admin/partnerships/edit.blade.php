...
<head>
    ...
    <title>Edit Partnership - PT. Bumi Laksamana Jaya</title>
    <meta name="description" content="Edit Partnership PT. Bumi Laksamana Jaya - Oil & Gas Solutions">
...
<body class="loading">
        ...
        <main class="main-content" id="main-content">
            <header class="page-header">
                <div class="header-left">
                    ...
                    <p>Edit partnership: {{ $partnership->name }}</p>
                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div>
                                <input type="text" id="name" name="name" class="form-control"
                                    placeholder="Masukkan nama perusahaan partner" 
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div>
                                ...
                                <p class="form-description">
                                    Upload logo perusahaan partner baru atau biarkan kosong untuk mempertahankan logo yang ada. Format yang didukung: PNG, JPG, GIF, SVG. Maksimal 2MB.
                                </p>
                            </div>
                            <div>
                                <!-- Current Logo -->
                                <div class="current-image-section">
                                    <span class="current-image-label">Logo saat ini:</span>
                                    <img src="{{ $partnership->logo_url }}" alt="{{ $partnership->name }}" class="current-image">
                                </div>
                                ...
                                <div class="image-upload" id="logo-container">
                                    <label for="logo" class="upload-placeholder">
                                        ...
                                        <span style="font-size: 0.9rem; font-weight: 500;">Klik untuk upload logo baru</span>
                                        <small style="font-size: 0.75rem; margin-top: 0.25rem; opacity: 0.8;">
                                            Format: PNG, JPG, GIF, SVG (Max: 2MB)<br>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div>
                                ...
                                <p class="form-description">
                                    Berikan deskripsi singkat tentang partnership ini dan jenis kerja sama yang dilakukan.
                                </p>
                            </div>
                            <div>
                                <textarea id="description" name="description" class="form-control"
                                    placeholder="Deskripsi tentang partnership ini...">{{ old('description', $partnership->description) }}</textarea>
                                @error('description')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <span>{{ $message }}</span>
                        ...
                        <div class="form-row">
                            ...
                            <div>
                                <input type="url" id="website" name="website" class="form-control"
                                    ...
                                    value="{{ old('website', $partnership->website) }}">
                                @error('website')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <span>{{ $message }}</span>
    ...
    <script>
        ...
        console.log('🤝 Partnership Edit Page loaded successfully!');
    </script>
</body>
